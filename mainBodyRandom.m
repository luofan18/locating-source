function [ result ] = mainBodyRandom( G, seedsNum, bins, binSize, binNum,beta, repetitionTimes,QjdTimes,minInfected,maxInfected )
trials = 0;
i = 0;
succeed = 0;
resultCursor = 0;
...
while i < repetitionTimes
    ...
    if sum(I) <= maxInfected
        ...
        if S==1
            ...
            i = i + 1;
            SS = randomSelectSeedsInInfection( I, seedsNum);

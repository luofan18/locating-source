...
for seedsNum = 1:maxSeedsNum
    ...
    for i =1:batchNum
        j((seedsNum-1)*batchNum+i) = batch(@mainBodyJordanCenter,1,{G, 1, bins, binSize, binNum,beta, repetitionTimes/batchNum,QjdTimes,minInfected,maxInfected,allShortestPaths});
    end
end
...
resultJordanCenterInfectedNum = [result2,QsdScore34562];
resultSummaryJordanCenterInfectedNum = [resultSummary2,averageQsd];
toc
toc

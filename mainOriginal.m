...
for seedsNum = 1:maxSeedsNum
    ...
    for i =1:batchNum
        j((seedsNum-1)*batchNum+i) = batch(@mainBodyOriginal,1,{G, 1, bins, binSize, binNum, beta,repetitionTimes/batchNum,QjdTimes,minInfected,maxInfected});
    end
end
...
resultOriginalInfectedNum = [result2,QsdScore34562];
resultSummaryOriginalInfectedNum = [resultSummary2,averageQsd];
toc
toc

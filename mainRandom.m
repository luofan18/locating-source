...
for seedsNum = 1:maxSeedsNum
    ...
    for i =1:batchNum
        j((seedsNum-1)*batchNum+i) = batch(@mainBodyRandom,1,{G, 1, bins, binSize, binNum, beta,repetitionTimes/batchNum,QjdTimes,minInfected,maxInfected});
    end
end
...
resultRandomInfectedNum = [result2,QsdScore34562];
resultSummaryRandomInfectedNum = [resultSummary2,averageQsd];
toc
toc
